# HTTP
[ ] Given a user wants to register, when an HTTP request is incoming with email and password, then invoke the registration module.
[ ] Given a user wants to register, when an HTTP request is incoming with email and password and email is duplicate from domain, then return an conflict response
